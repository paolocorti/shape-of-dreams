  ...
  return (
    <g className='bluepetal bluepetal100'>
      <g id={`bluepetal-${id}`}>
        <path
          className='st0'
          d='M0.4,23.9c-5.7,3.5,61.4,32.2,131.8,30.5C202.6,53,260.3,24.3,262.5,18c3.5-10-19.2-6.1-19.2-6.1l0,0
	c-6.6,0.7-16.4,1.1-24.8,1.1c-16-0.1-34.5-3.5-49-5.4L166.1,7c-10.6-0.9-23.3-2.9-35-3.2C131.1,3.8,44.5-3.1,0.4,23.9z'
        />
        <g>
          <path
            className='st1'
            d='M29.8,16.2c7.5-1.1,15.2-1.4,22.8-0.9S67.7,17,75,19.1c3.7,1,7.3,2.3,10.8,3.8s6.9,3.1,10.4,4.7
        ...
        <g>
          <path
            className='st1'
            d='M135.1,17.4c2.5,0,5,0.7,7.3,1.8s4.4,2.4,6.6,3.6c2.2,1.2,4.4,2.3,6.8,3c2.4,0.7,4.9,1,7.4,1.1
		c-2.5,0-5-0.3-7.4-0.9c-2.4-0.7-4.7-1.7-6.9-2.8c-2.2-1.2-4.3-2.5-6.6-3.5s-4.7-1.6-7.1-1.6L135.1,17.4z'
          />
        </g>
        <path
          className='st1'
          d='M0.4,24.4c50.8-18.5,116.8-8.3,165.9-3c23.4,2.5,53,6.9,79.3,1.8c4.4-0.8,8.7-1.9,12.9-3.3
