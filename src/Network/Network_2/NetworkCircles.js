      ...
      {state => {
        ...
        return (
          <g id="circles" transform="translate(-42,-40)">
            <image style={{ cursor: 'pointer', opacity: 0.5 }} width="192" height="192" xlinkHref={petal1} transform="matrix(0.235 0 0 0.235 232.6282 111.0258)" >
            </image>
            <image style={{ cursor: 'pointer', opacity: 0.5 }} width="192" height="192" xlinkHref={petal2} transform="matrix(0.235 0 0 0.235 288.0681 354.1458)">
            </image>
            ...
            <image style={{ cursor: 'pointer', opacity: 0.5 }} width="192" height="196" xlinkHref={petal4} transform="matrix(0.2332 0 0 0.2332 107.7625 267.0938)">
            </image>
            ...
            <image className='pointer' style={{ cursor: 'pointer', opacity: opacity }} width="192" height="192" xlinkHref={petal6} transform="matrix(0.2338 0 0 0.2338 332.7082 159.2658)" onClick={() => setClicked('EN')} onMouseEnter={() => isMobile ? noop : setSelected('EN')} onMouseLeave={() => isMobile ? noop : setSelected('')}>
            </image >
