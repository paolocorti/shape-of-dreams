  ...
  return (
    <g id="circles">
      ...
      <g>
        ...
        <circle class="st3" cx="355" cy="182.1" r="22" style={{ opacity: selected === 'EN' || selected === 'FR' || selected === 'SP' ? 1 : 0 }} />
        <circle class="st3" cx="380.2" cy="290" r="22" style={{ opacity: selected === 'FR' || selected === 'EN' || selected === 'PO' ? 1 : 0 }} />
        <circle class="st3" cx="199.6" cy="376.8" r="22" style={{ opacity: selected === 'PO' || selected === 'SP' || selected === 'FR' ? 1 : 0 }} />
      </g>
    </g >
  );
};
