    ...
    >
      {state => {
        ...
        <g id="lines" transform="translate(-42,-40)">
            ...
            <path className="network_1_1" d="M200.7,376.1c21.9-83.7,78.5-153.4,153.6-192.8" stroke-dasharray={dashArray} stroke-dashoffset={dashoffset} style={{ opacity: selected === '' ? 1 : (selected === 'EN' || selected === 'PO' ? 1 : 0) }} />
            ...
            <path className="network_1_2" d="M156.8,183.7c41.1,3,82.2,13.5,121.6,32.3c39.2,18.7,73.2,43.9,101.4,73.7" stroke-dasharray={dashArray} stroke-dashoffset={dashoffset} style={{ opacity: selected === '' ? 1 : (selected === 'SP' || selected === 'FR' ? 1 : 0) }} />
        </g>
        )
      }}
    </Animate>
