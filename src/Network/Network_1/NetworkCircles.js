...
const NetworkCircles = ({ selected, setSelected }) => {
  return (
    <g id="circles" transform="translate(-35,-20)">
      ...
      <image className='pointer' style={{ cursor: 'pointer', enableBackground: 'new' }} width="192" height="192" xlinkHref={petal6} transform="matrix(0.2338 0 0 0.2338 332.7082 159.2658)" onClick={() => setSelected('EN')} onMouseEnter={() => setSelected('EN')} onMouseLeave={() => setSelected('')}>
      </image >
