      ...
      {state => {
        ...
        return (
          <g id="circles" transform="translate(-42,-40)">
            ...
            <image style={{ cursor: 'pointer', opacity: opacity }} width="192" height="192" xlinkHref={petal3} transform="matrix(0.235 0 0 0.235 176.9482 354.1458)" onClick={() => setSelected('PO')} onMouseEnter={() => isMobile ? noop : setSelected('PO')} onMouseLeave={() => isMobile ? noop : setSelected('')}>
            </image>
            ...
            <image style={{ cursor: 'pointer', opacity: opacity }} width="192" height="192" xlinkHref={petal5} transform="matrix(0.2344 0 0 0.2344 132.3681 159.2057)" onClick={() => setSelected('SP')} onMouseEnter={() => isMobile ? noop : setSelected('SP')} onMouseLeave={() => isMobile ? noop : setSelected('')}>
            </image>
            <image className='pointer' style={{ cursor: 'pointer', opacity: opacity }} width="192" height="192" xlinkHref={petal6} transform="matrix(0.2338 0 0 0.2338 332.7082 159.2658)" onClick={() => setSelected('EN')} onMouseEnter={() => isMobile ? noop : setSelected('EN')} onMouseLeave={() => isMobile ? noop : setSelected('')}>
            </image >
            <image style={{ cursor: 'pointer', opacity: opacity }} width="192" height="188" xlinkHref={petal7} transform="matrix(0.2368 0 0 0.2368 357.0125 267.6838)" onClick={() => setSelected('FR')} onMouseEnter={() => isMobile ? noop : setSelected('FR')} onMouseLeave={() => isMobile ? noop : setSelected('')}>
            </image>
            <g>
