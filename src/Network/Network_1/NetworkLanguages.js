...
const NetworkLanguages = ({ selected }) => {
  return (
    <g id="languages">
      ...
      <g>
        <text transform="matrix(1 0 0 1 345.1813 185.9434)" class="st5 st6 st7">EN</text>
      </g>
      <g>
        <text transform="matrix(1 0 0 1 370.6091 294.1885)" class="st5 st6 st7">FR</text>
      </g>
      <g class="st4">
        <text transform="matrix(1 0 0 1 301.9733 380.9941)" class="st5 st6 st7">JA</text>
      </g>
      <g>
      ...
      <g>
        <text transform="matrix(1 0 0 1 145.8552 185.9434)" class="st5 st6 st7">SP</text>
      </g>
    </g>
  );
};
