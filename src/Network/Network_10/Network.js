...
const Network10 = ({ year }) => {
  const [selected, setSelected] = useState('');
  const svgHeight = isMobile ? window.innerWidth : 600;
  ...
  return (
    <div className='flex w-100 justify-center items-center flex-column'>
      <div
        className='mt0 value absolute'
        style={{ fontSize: '16px', opacity: 0.6, top: '10px' }}
      >
